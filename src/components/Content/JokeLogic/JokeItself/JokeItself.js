...
function JokeItself({ id, value, category, updated_at, likeJoke }) {
    return (
        <div className="rectangle">
            ...
            <div className="joke">
                <button className="favorite_joke" onClick={() => likeJoke(id)}><FontAwesomeIcon className="favorite_icon" icon={ faHeart } size="2x" /></button>
                <div className="id">ID: <a id="link" href={`https://api.chucknorris.io/jokes/${id}`}>{id}</a></div>
